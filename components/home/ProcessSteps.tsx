...
export function ProcessSteps() {
  return (
    <section className="bg-(--color-accent)/5 py-16 sm:py-20">
          ...
          {siteConfig.home.process.steps.map((step, index) => (
            ...
            >
              <div className="flex items-center gap-3">
                <span className="flex h-9 w-9 items-center justify-center rounded-full border border-(--color-accent)/30 bg-(--color-accent)/10 text-sm font-semibold text-(--color-accent)">
